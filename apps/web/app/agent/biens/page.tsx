...
/**
 * L'accueil du back-office — la liste des biens.
 *
 * Elle vivait à /agent/dashboard alors que l'onglet s'appelle « Biens » et
 * pointe sur /agent/biens : cette adresse-là n'existait pas, et tout retour
 * arrière du navigateur y atterrissait en 404. Même correctif que pour
 * /agent/reglages → /agent/parametres : la page prend le nom que l'interface
 * annonce, l'ancienne adresse devient une redirection.
 */
...
export default async function AgentBiensPage({
  searchParams,
}: {
