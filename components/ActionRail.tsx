...
export default function ActionRail({ property, isFavorite, onToggleFavorite, onContact }: ActionRailProps) {
  return (
    <div className="absolute right-3 bottom-28 z-20 flex flex-col items-center gap-4">
      <RailButton
        icon={<MessageSquare size={34} strokeWidth={1.5} className="text-white" />}
        onClick={onContact}
      />
      <RailButton
        icon={<Phone size={32} strokeWidth={1.5} className="text-white" />}
      />
      <RailButton
        icon={<CalendarPlus size={32} strokeWidth={1.5} className="text-white" />}
      />
      <RailButton
        icon={
          <Heart
      ...
      />
      <RailButton
        icon={<Send size={31} strokeWidth={1.5} className="text-white" />}
